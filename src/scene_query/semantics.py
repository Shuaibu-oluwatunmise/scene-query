"""Grounding DINO + SAM 2 — open-vocabulary segmentation."""
...
def load_gsam2_models(device: str = "cuda") -> tuple:
    ...
    try:
        ...
        raise ImportError("groundingdino not installed. Run python setup.py.")
    try:
        from sam2.build_sam import build_sam2
    except ImportError:
        raise ImportError("sam2 not installed. Run python setup.py.")
